...
class InboundSession:
    ...
    def _on_qos2(
        ...
        *,
        ...
        if existing is not None:
            ...
            engine._send_protocol_response(_encode_pubrec_success(mid))
            return
    ...
    def _complete_recovered_qos1_auto(self, mid: int) -> None:
        ...
        self._engine._send_protocol_response(_encode_puback_success(mid))
    ...
    def on_pubrel(self, raw: RawPacket) -> None:
        ...
        if record is None:
            ...
            engine._send_protocol_response(_encode_pubcomp_success(mid))
            return
        state = record.state
