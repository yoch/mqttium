...
Campaign run: https://github.com/yoch/mqttium/actions/runs/31032603265

The manually equivalent full finalization matrix completed successfully with 20 cycles,
500 QoS 1 messages per cycle and 19 forced reconnects per scenario.
...
| EMQX 5.8.9 | 3.1.1 + 5 | 20,000 | 20,000 | 0 | `sha256:85f20de29c55a1cd224ed521d30222f987d3ebb486036878b7359c26775e28e2` |
| HiveMQ CE 2026.5 | 3.1.1 + 5 | 20,000 | 20,000 | 0 | `sha256:91a4d930246b2cd39e124b10e2e5ae896afaf290aa29c43c83f9aa1d3e3b155f` |
...
- non-zero protocol/writer/decoder high-water values, proving the bounded paths were exercised.

Artifacts expire on 2026-09-04. Their digests and the run URL are retained here so the
release decision remains auditable after expiry.
