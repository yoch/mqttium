...
| [INLINE-CALLBACK-DELIVERY-2026-09-14](INLINE-CALLBACK-DELIVERY-2026-09-14.md) | Current evidence | Callback worker removal, coroutine-free delivery handoff, decode/publish hot-path trim, open-PR disposition, RSS bytecode harness bias, and RC14 diagnostics/network comparison on a cloud host; no parity or merge claim. Addendum: profiler-free receive-path stage decomposition, plain `RawPacket` prototype, and closure of the receive hot-path question; second addendum: `publish_nowait(qos=0)` direct path reordered ahead of the generic preflight, closed-loop parity with RC14 restored; third addendum: one shared immutable value for empty MQTT 5 property tables, closing the MQTT 5 reception excess over MQTT 3.1.1; fourth addendum: external matrix #39 post-fix validation of both fixes and direct paired qualification showing the reported QoS 1 RTT drop was environmental |
...
| [RELEASE-CANDIDATE-1.0.0rc11](https://github.com/yoch/mqttium/blob/main/docs/reports/RELEASE-CANDIDATE-1.0.0rc11.md) | Superseded | RC12 candidate evidence and current publication conditions |
| [RELEASE-CANDIDATE-1.0.0rc12](https://github.com/yoch/mqttium/blob/main/docs/reports/RELEASE-CANDIDATE-1.0.0rc12.md) | Superseded | Later release candidates and final release evidence |
| [RELEASE-CANDIDATE-1.0.0rc13](https://github.com/yoch/mqttium/blob/main/docs/reports/RELEASE-CANDIDATE-1.0.0rc13.md) | Current evidence | RC13 candidate evidence; tag/publication conditional on post-merge main gates |
...
| [RUNTIME-FUZZER-COMPOSITION-LONG-CAMPAIGN-2026-08-26](https://github.com/yoch/mqttium/blob/main/docs/reports/RUNTIME-FUZZER-COMPOSITION-LONG-CAMPAIGN-2026-08-26.md) | Current evidence | One-million-seed V2 x86-64 campaign at 48 steps: zero failures, all six composition pairs, all 64 release traces, and recorded diversity |
...
| [RUNTIME-FUZZER-SHARED-RUNNER-TIMEOUTS-2026-08-26](https://github.com/yoch/mqttium/blob/main/docs/reports/RUNTIME-FUZZER-SHARED-RUNNER-TIMEOUTS-2026-08-26.md) | Current evidence | V2/V3 contention incidents, replay classification, and the explicit shared-runner timeout profile |
...
| [RECEIPT-WAITER-FUTURES-2026-09-06](https://github.com/yoch/mqttium/blob/main/docs/reports/RECEIPT-WAITER-FUTURES-2026-09-06.md) | Current evidence | Per-waiter futures for `PublishReceipt.wait()`; matched-load campaign blocks the change on a median-latency regression at 5000 msg/s |
