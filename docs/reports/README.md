...
| [SPEC-CONFORMANCE-RESEARCH-AGENT-C-2026-08-25](https://github.com/yoch/mqttium/blob/main/docs/reports/SPEC-CONFORMANCE-RESEARCH-AGENT-C-2026-08-25.md) | Current evidence | Mapping of normative MQTT 3.1.1 and 5.0 requirements to current state machine, code gaps, and deterministic evidence |
