...
| Date | Report | Records |
| --- | --- | --- |
| 2026-08-14 | [`ASYNC-HANDOFF-AUDIT-2026-08-14.md`](ASYNC-HANDOFF-AUDIT-2026-08-14.md) | Codebase-wide audit of avoidable async handoffs: two measured hot-path changes isolated in PRs #221 and #223, and an explicit no-change decision for cold CONNACK callback handling. |
