...
| Date | Report | Records |
| --- | --- | --- |
| 2026-08-12 | [`HARDENING-AUDIT-1.0.0rc2.md`](HARDENING-AUDIT-1.0.0rc2.md) | Hardening pass over `1.0.0rc2` (`c34a949`): confirmed defects #186–#188, #190–#193, suggested fixes, and false positives from expert rounds. |
