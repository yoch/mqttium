...
| [RELEASE-CANDIDATE-1.0.0rc12](https://github.com/yoch/mqttium/blob/main/docs/reports/RELEASE-CANDIDATE-1.0.0rc12.md) | Current evidence | RC12 hosted, controlled local and ARM64 tournament evidence; post-merge ARM64 CI remains the publication condition |
