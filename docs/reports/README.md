...
| [PUMP-CONCURRENCY-REDTEAM-2026-08-24](https://github.com/yoch/mqttium/blob/main/docs/reports/PUMP-CONCURRENCY-REDTEAM-2026-08-24.md) | Superseded | Bug schedules at `a336f83`; current behaviour is the fix report below |
| [PUMP-CONCURRENCY-REDTEAM-FIX-2026-08-24](https://github.com/yoch/mqttium/blob/main/docs/reports/PUMP-CONCURRENCY-REDTEAM-FIX-2026-08-24.md) | Current evidence | Minimal WritePump/EffectPump liveness fixes for those schedules |
