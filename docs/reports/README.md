...
| [DELIVERY-RECONNECT-RACES-2026-08-24](https://github.com/yoch/mqttium/blob/main/docs/reports/DELIVERY-RECONNECT-RACES-2026-08-24.md) | Current evidence | Application-delivery × reconnect lifecycle race campaign |
