...
| Date | Report | Records |
| --- | --- | --- |
| 2026-08-14 | [`HYPOTHESIS-PERF-AUDIT-2026-08-14.md`](HYPOTHESIS-PERF-AUDIT-2026-08-14.md) | Hypothesis-vs-measurement audit: empty inbound SQLite probes; MQTT 5 QoS 1 property table encoded twice on launch; connected QoS 1/2 Topic Name encoded three times; small-delivery bool-veto of decoded MQTT 5 properties that fit the limit; accounted inbound re-encoding a decoded table; MQTT 5 QoS 0 still on the generic field decoder; critical pass refusing nowait-preview, owned-bytes and nanosecond non-fixes. |
