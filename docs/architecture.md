...
When one network read yields consecutive terminal QoS 1/2 results, the reader
settles that prefix in one ordered pump pass; single acknowledgements and every
non-terminal effect retain the general drain.
